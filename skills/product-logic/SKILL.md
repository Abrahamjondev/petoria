---
name: product-logic
description: Review Petoria product API consistency across GraphQL operations, DTOs, schemas, enums, filters, and remaining legacy terminology.
---

# Petoria Product API Review
